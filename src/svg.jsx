...
export function Education({color="text-indigo-500"}) {
  ...
  return(
      <svg className={color+"h-4 w-4 fill-[#8e8e8e]"} title="Education" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
...
export function Skills({color="text-indigo-500"}) {
  ...
  export function Github({color="text-indigo-500"}) {
    ...
    return(
        <svg className={color+"h-8 w-8 fill-[#050505]"} viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
