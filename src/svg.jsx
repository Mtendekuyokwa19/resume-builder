export function PersonalDataIcon({color="text-indigo-500"}) {
  ...
  return (
    <svg className={color+"h-4 w-4  dark:fill-[#3e3d3d] fill-[#8e8e8e]"}viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
...
export function Education({color="text-indigo-500"}) {
  ...
  return(
      <svg className={color+"h-4 w-4 dark:fill-[#3e3d3d] fill-[#8e8e8e]"} title="Education" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
...
export function Experience({color="text-indigo-500"}) {
  ...
  return(
    <svg className={color+"h-4 w-4 dark:fill-[#3e3d3d] fill-[#8e8e8e]"} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
...
export function Skills({color="text-indigo-500"}) {
    ...
    return(
      <svg className={color+"h-4 w-4 dark:fill-[#3e3d3d] fill-[#8e8e8e]"} viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
  ...
  export function Preview({color="text-indigo-500"}) {
    ...
    return (
      <svg
        className="sm:h-6 sm:w-6 h-4 w-4  text-textResume"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
  ...
  export function Github({color="text-indigo-500"}) {
    ...
    return(
        <svg className={color+" sm:h-8 sm:w-8 w-6 h-6 dark:fill-[#ffffff]"} viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
